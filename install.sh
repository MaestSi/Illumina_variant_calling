...
conda create -n Illumina_variant_calling_env fastqc fastp fgbio picard bwa samtools java-jdk qualimap
wget https://github.com/broadinstitute/gatk/releases/download/4.2.0.0/gatk-4.2.0.0.zip
unzip gatk-4.2.0.0.zip

echo -e "\n"
echo "Modify variables PIPELINE_DIR and MINICONDA_DIR in config_Illumina_variant_calling.sh"
